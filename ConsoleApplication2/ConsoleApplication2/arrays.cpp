...
void MakeMatrix(int** matrix, int rows, int cols) {
	...
	cout.setf(ios::left);
	for (int matrixCounterOfRows = 0; matrixCounterOfRows < rows; matrixCounterOfRows++) {
		for (int matrixCounterOfCols = 0; matrixCounterOfCols < cols; matrixCounterOfCols++){
			cout.width(3);
...
bool MultiplyMatrices(int **matrixA, int aRows, int aCols, int **matrixB, int bRows, int bCols, int **resultMatrix) {
	...
	switch (aCols == bRows) {
	case 1: {
		for (int multiplyRowsOfMatrixA = 0; multiplyRowsOfMatrixA < aRows; multiplyRowsOfMatrixA++) {
			for (int multiplyColsOfMatrixB = 0; multiplyColsOfMatrixB < bCols; multiplyColsOfMatrixB++) {
				summ = 0;
				for (int colsOfMatrixAAndRowsOfMatrixB = 0; colsOfMatrixAAndRowsOfMatrixB < aCols; colsOfMatrixAAndRowsOfMatrixB++) {
					summ += matrixA[multiplyRowsOfMatrixA][colsOfMatrixAAndRowsOfMatrixB] * matrixB[colsOfMatrixAAndRowsOfMatrixB][multiplyColsOfMatrixB];
				}
