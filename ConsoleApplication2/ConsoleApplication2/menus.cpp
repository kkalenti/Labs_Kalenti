...
void GeneralMenu(){
	cout << "Выберите лабораторную работу:" << endl <<
		...
		"6.Наследование и полиморфизм" << endl <<
		"7.Обобщение" << endl <<
...
void FifthLabMenu() {
	cout << "Лабораторная №5." << endl << "Выберите номер задания:" << endl <<
		"1.Работа с классами" << endl << endl;
}

void SixthLabMenu() {
	cout << "Лабораторная №6." << endl << "Выберите номер задания:" << endl <<
		"1.Наследование и полиморфизм" << endl << endl;
}
